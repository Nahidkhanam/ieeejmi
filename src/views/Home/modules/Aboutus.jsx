...
function AboutUs() {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex flex-col font-body rounded-lg md:shadow-xl bg-white md:p-10 p-5 justify-center items-center md:w-5/6 md:px-20 py-10 md:py-14 mb-20 mt-20 z-10">
        <div className="flex">
